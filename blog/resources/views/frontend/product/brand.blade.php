                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                            <div class="productinfo text-center">
                                <img style="width: 242px; height: 252px;" src="{{ URL::to('upload/product/'.$value['user_id'].'/'.$getArrImage[0]) }}" alt="" />
                               

                                    @if ($value['new'] != 0 && $value['new'] != "")
                                        <span style="text-decoration: line-through" class="price_sale overlay">{{ number_format($value['price']) }}$</span>
                                        <span style="color: red"  class="price overlay">{{ number_format($value['price']*(100-$value['sale'])/100) }}$</span>
