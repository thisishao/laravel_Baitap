	                ...
	                <div class="product-image-wrapper">
	                    <div class="single-products">
	                            <div class="productinfo text-center">
	                                <img src="{{ URL::to('upload/product/'.$value['user_id'].'/'.$getArrImage[0]) }}" alt="" />
	                               

	                                @if ($value['new'] == 0)
	                                <span class="price">{{ number_format($value['price']) }}</span>
	                                @else
	                                <span style="text-decoration-line:line-through"  class="price_sale">{{ number_format($value['price']) }}$</span>
	                                <span style="color: red" class="price">{{ number_format($value['price']*(100-$value['sale'])/100) }}$</span>
	                                @endif
	                            ...
	                            <div class="product-overlay">
	                                <div class="overlay-content">
	                                    ...
	                                    @else
	                                        <span style="text-decoration-line:line-through"  class="price_sale_overlay">{{ number_format($value['price']) }}$</span>
	                            ...
	                            <img class="new" src="{{ $value['new']==0 ? URL::to('frontend/images/home/new.png') : URL::to('frontend/images/home/sale.png') }}">
	                    </div>
	                    <div class="choose">
	                        <ul class="nav nav-pills nav-justified">
	                            <li><a href="{{ route('frontend.product.details', ['id' => $value['id'], 'slug' => Str::slug($value['name'])]) }}"><i class="fa fa-plus-square"></i>Product detail</a></li>
	            ...
	            <div class="col-sm-4">
	                <div class="product-image-wrapper">
	                    <div class="single-products">
	                            ...
	                            <img class="new" src="{{ $value['new']==0 ? URL::to('upload/icon/new.png') : URL::to('upload/icon/sale.png') }}">
	                    </div>
	                    <div class="choose">
	                        <ul class="nav nav-pills nav-justified">
