    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Product {{ $getProduct['name'] }} </h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Product {{ $getProduct['name']}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="view-product"> 
                    @foreach($getArrImage as $value)
                        <a href=""><img style="width: 100px ; height: 100px" src="{{ URL::to('upload/product/'.$getProduct['user_id'].'/'.$value) }}" alt=""></a>
                    @endforeach
                </div>
            </div>
            <div class="col-sm-12">
